# -*- coding: utf-8 -*-
"""aim2_unsupervised_deepmhci_nsclc
Work distribution: 
...
Original file is located at
    https://colab.research.google.com/drive/1Jj1cyWs3BcxQE4e3UkG9JlObM-IFoCjv
"""
...
# Load DeepMHC data for neoantigen HLA binders and NSCLC subtype label
'''
...
data_hla_A_1 = pd.read_csv('/content/drive/Shareddrives/BMI212/Analysis/results_Jun/gene_counts_per_sample_deepmhci_NSCLC_0.1_A.csv', header=0, index_col=0)
data_hla_B_1 = pd.read_csv('/content/drive/Shareddrives/BMI212/Analysis/results_Jun/gene_counts_per_sample_deepmhci_NSCLC_0.1_B.csv', header=0, index_col=0)
data_hla_AB_1 = pd.read_csv('/content/drive/Shareddrives/BMI212/Analysis/results_Jun/gene_counts_per_sample_deepmhci_NSCLC_limit=1_combined.csv', header=0, index_col=0)

# paths to data generated from DeepMHCi, 0.2
data_hla_A_2 = pd.read_csv('/content/drive/Shareddrives/BMI212/Analysis/results_Jun/gene_counts_per_sample_deepmhci_NSCLC_0.2_A.csv', header=0, index_col=0)
data_hla_B_2 = pd.read_csv('/content/drive/Shareddrives/BMI212/Analysis/results_Jun/gene_counts_per_sample_deepmhci_NSCLC_0.2_B.csv', header=0, index_col=0)
data_hla_AB_2 = pd.read_csv('/content/drive/Shareddrives/BMI212/Analysis/results_Jun/gene_counts_per_sample_deepmhci_NSCLC_limit=2_combined.csv', header=0, index_col=0)
...
data_names_1 = ['NSCLC: HLA-A, 0.1', 'NSCLC: HLA-B, 0.1', 'NSCLC: Combined, 0.1']
data_1 = [data_hla_A_1, data_hla_B_1, data_hla_AB_1]

for data, name in zip(data_1, data_names_1):
  print(f"{name}: {data.shape}")

data_names_2 = ['NSCLC: HLA-A, 0.2', 'NSCLC: HLA-B, 0.2', 'NSCLC: Combined, 0.2']
...
data_scaled_1 = [data_hla_A_1_scaled, data_hla_B_1_scaled]
data_scaled_2 = [data_hla_A_2_scaled, data_hla_B_2_scaled]
...
def plot_kmeans_scores_projections(data_dict, n_components, kmeans_sil_list_1, kmeans_sil_list_2, ks):
    ...
    # ChatGPT was used to generate the plotting code below, specifically to format plot layout
    ...
    plt.title(f'Mean Silhouette Scores by k (PCA n_components = {n_components})')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    plt.show()
